		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					...
					<h5 class="job-head pt-4">PAGE 1 OF 112</h5>
					@if(session('message'))
					...
					<div class="py-2">
						<div class="card">
							<div class="card-body job-card">
								...
								<div class="row">
									<div class="col-md-4">
										<p><strong>Posted by: </strong><br> {{ $value->post_by }}<br><strong><i class="fa fa-map-marker"></i> Location: </strong><br>{{ $value->location }}</p>
									</div>
									<div class="col-md-4">
										<p><strong><i class="fa fa-info-circle"></i>Curriculum:</strong>{{ $value->curriculum }}<br><i class="fa fa-info-circle"></i><strong>School: </strong>{{ $value->school }}<br><i class="fa fa-info-circle"></i><strong>Days: </strong>{{ $value->number_of_days }} days/week<br><i class="fa fa-info-circle"></i><strong>Teaching time: </strong>{{ $value->teaching_time }}<br><i class="fa fa-info-circle"></i><strong>Salary: </strong> {{ $value->salary }} tk/month</p>
									</div>
									<div class="col-md-4">
										<p><strong><i class='fa fa-hand-lizard-o'></i> -Subject: <br></strong>{{ $value->subject }},<br><strong><i class='fa fa-comment'></i> -In details: <br></strong>{{ $value->in_details }}</p>
									</div>
									@guest
